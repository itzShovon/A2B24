...
<head>
    ...
    <link href="{{url('/')}}/lib/owlcarousel/assets/owl.theme.default.min.css" rel="stylesheet">
    <link href="{{url('/')}}/lib/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="{{url('/')}}/lib/animate/animate.min.css" rel="stylesheet">
    <link href="{{url('/')}}/lib/modal-video/css/modal-video.min.css" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="header header-hide">
        <div class="container">
            ...
            <div id="logo" class="pull-left">
                <h1><a href="#body" class="scrollto"><span>A2B</span>24</a></h1>
    ...
    <section id="get-started" class="padd-section text-center wow fadeInUp">
        ...
        <div class="container">
            <div class="section-title text-center">
                ...
                <h2>simple systematic smart </h2>
                <p class="separator">Smart, stylish, productive, and powerful choice .</p>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-7 col-lg-5">
                    <div class="about-content">
                        ...
                        <h2><span>{{ config('app.name', 'Laravel') }}</span>UI Design Mobile </h2>
                    ...
                    <div class="col-md-9 col-lg-6">
                        <form class="form-inline" method="POST" action="#">
                            ...
                            <button type="submit" class="btn btn-default"><i
                                    class="fa fa-location-arrow"></i>Subscribe</button>
  ...
  ============================-->
    ...
    <script src="{{url('/')}}/lib/modal-video/js/modal-video.js"></script>
